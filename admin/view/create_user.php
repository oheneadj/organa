...
<head>
  ...
  <title>Create User | Organa</title>
</head>
          ...
          <div class="card-body">
              ...
              <form class="row g-3">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputNanme4" placeholder="0243633538">
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">Date of Birth</label>
                  <input type="date" class="form-control" id="inputEmail4" placeholder="02/04/2022">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputPassword4" placeholder="Street">
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Phone Number</label>
                  <input type="text" class="form-control" id="inputAddress" placeholder="0243633538">
                </div>
                <div class="col-6">
